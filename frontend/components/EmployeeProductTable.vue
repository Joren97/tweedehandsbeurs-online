<template>
  <section class="section__list-detail">
      ...
      <tbody v-else>
        <tr v-for="item in products">
          ...
          <td class="table__column column__actions">
            ...
            <button class="" @click="openEditProductModal(item)">
    ...
    <EditProductModal
      ...
      :prices="prices"
      v-show="showEditProductModal"
      @dismiss-modal="dismissModal()"
      @product-updated="dismissModal(true)"
    />
  </section>
</template>
<script setup>
...
const dismissModal = (updated = false) => {
  showEditProductModal.value = false;
  if (updated) emit("refresh");
};
